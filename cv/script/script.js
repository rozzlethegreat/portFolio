...
function drawChart() {
    ...
    dataTable.addRows([
        ...
        [ 'Place', 'Holland', new Date(2014, 5, 28), new Date(2015, 6, 5)],
        [ 'Place', 'Wellington', new Date(2015, 6, 5), new Date(2018, 1, 30)],
        ...
        [ 'Work', 'Mad Mex', new Date(2015, 7, 28), new Date(2017, 8, 31) ],
        [ 'Work', 'BNZ', new Date(2017, 9, 1), new Date(2018, 1, 16) ],
