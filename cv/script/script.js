...
function drawChart() {
    ...
    dataTable.addRows([
        ...
        [ 'Place', 'Wellington', new Date(2015, 6, 5), new Date(2024, 3, 31)],
        ...
        [ 'Work', 'Xequals', new Date(2020, 3, 31), new Date(2024, 3, 31) ],
        ...
        [ 'Study', 'Whitecliffe College', new Date(2021, 6, 10), new Date(2023, 6, 15)]
